...
MCP_INSTRUCTIONS = (
    ...
    "and can return a compact background_context built directly from retrieved memory; for normal "
    "agent use, prefer a lean response_level such as minimal instead of verbose retrieval JSON. "
