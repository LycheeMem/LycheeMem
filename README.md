...
- [03/30/2026] Evaluated on PinchBench with the LycheeMem OpenClaw plugin: compared to OpenClaw's native memory, it achieved an ~13% score improvement, while reducing token consumption by ~71% and cost by ~55%!
