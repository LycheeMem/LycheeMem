...
<div align="center">
  <div style="border: 1px solid #e1e4e8; border-radius: 8px; padding: 20px; background-color: #f6f8fa; font-family: -apple-system,BlinkMacSystemFont,Segoe UI,Helvetica,Arial,sans-serif;">
    <h3 style="margin-top: 0; color: #24292e;">LycheeMem 记忆系统架构</h3>
    <div style="display: flex; gap: 15px; justify-content: center; flex-wrap: wrap; margin-top: 15px;">
      <div style="border: 1px solid #d1d5da; border-radius: 6px; padding: 15px; background: white; min-width: 180px; text-align: left; box-shadow: 0 1px 3px rgba(27,31,35,0.04);">
        <h4 style="margin: 0 0 10px 0; color: #0366d6;">工作记忆</h4>
        <p style="margin: 0; font-size: 13px; color: #586069;">(情景记忆)</p>
      ...
      <div style="border: 1px solid #d1d5da; border-radius: 6px; padding: 15px; background: white; min-width: 180px; text-align: left; box-shadow: 0 1px 3px rgba(27,31,35,0.04);">
        <h4 style="margin: 0 0 10px 0; color: #0366d6;">语义记忆</h4>
        <p style="margin: 0; font-size: 13px; color: #586069;">(知识图谱)</p>
        <ul style="margin: 10px 0 0 0; padding-left: 18px; font-size: 13px; line-height: 1.6; color: #24292e;">
          <li>实体节点存储</li>
          <li>双时态事实建模</li>
          <li>社区聚类摘要</li>
      ...
      <div style="border: 1px solid #d1d5da; border-radius: 6px; padding: 15px; background: white; min-width: 180px; text-align: left; box-shadow: 0 1px 3px rgba(27,31,35,0.04);">
        <h4 style="margin: 0 0 10px 0; color: #0366d6;">程序记忆</h4>
        <p style="margin: 0; font-size: 13px; color: #586069;">(技能库)</p>
        <ul style="margin: 10px 0 0 0; padding-left: 18px; font-size: 13px; line-height: 1.6; color: #24292e;">
          <li>技能条目持久化</li>
          <li>HyDE 假设性检索</li>
        </ul>
